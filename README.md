# Plant Shop
Plant Shop application for the Spring Certification Exam Preparation code examples.
...
For further reference, please consider the following documentation and guides:
...
* [Graphite](https://docs.spring.io/spring-boot/docs/2.6.3/reference/html/production-ready-features.html#production-ready-metrics-export-graphite)
